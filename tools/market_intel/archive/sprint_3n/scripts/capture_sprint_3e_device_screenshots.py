"""Capture Sprint 3E Market Insights polish on a connected Android device/emulator."""
...
OUT = REPO / "tools" / "market_intel" / "screenshots" / "sprint_3e" / "after"

SCENARIOS = [
    ("2_market_insights_screen.png", "Luck", "18 recent sales", "$42", False),
    ("3_market_insights_series_estimate.png", "Hope", "Using Series Estimate", "$40", False),
    ("4_market_insights_dark_mode.png", "Luck", "18 recent sales", "$42", True),
]
...
def dump_ui() -> str:
    adb("shell", "uiautomator", "dump", "/sdcard/sprint_3e_ui.xml")
    return adb("shell", "cat", "/sdcard/sprint_3e_ui.xml").replace("&#10;", "\n")
...
def screencap(filename: str) -> None:
    ...
    remote = "/sdcard/sprint_3e_cap.png"
    local = OUT / filename
