...
- [`COLLECTION_ARCHITECTURE_NOTES.md`](COLLECTION_ARCHITECTURE_NOTES.md) — Collection maintenance-mode tradeoffs (snapshot persistence, journey history, **Collector Type resolver 6.1**)
...
| Insights | Collector Type reveal (**10** Identity archetypes, resolver **6.1**) + live Journey; At a Glance / progress |
...
*Last updated: 2026-07 — Collector Type resolver **6.1** (see [`COLLECTION_ARCHITECTURE_NOTES.md`](COLLECTION_ARCHITECTURE_NOTES.md)); also reflects runtime bootstrap catalog removal, catalog persistence sync, provider propagation, Performance Characteristics audit, and Collection Insights Dashboard profile baseline.*
