...
Durable product semantics: [`PDR-001 Collector Type`](decisions/product/PDR-001-collector-type-semantics.md), [`PDR-002 Completion`](decisions/product/PDR-002-completion-semantics.md), and [`PDR-003 Dreamer`](decisions/product/PDR-003-dreamer-semantics.md).
