...
Checklist of how the live repo compares to [`.cursor/ARCHITECTURE.md`](../../../.cursor/ARCHITECTURE.md). **Docs-only** audit ??not a mandate to refactor everything listed under drift.
