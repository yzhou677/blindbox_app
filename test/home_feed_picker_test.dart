...
void main() {
  ...
  test('latest includes releases within 3 months, newest first', () {
    final bundle = _bundle([
      _series('a', '2026-05-10'),
      _series('b', '2026-04-20'),
      _series('c', '2026-03-01'),
      _series('d', '2026-02-25'),
      _series('outside', '2025-01-01'),
    ]);
  ...
  test('trending uses 3–12 month window and excludes latest', () {
    final bundle = _bundle([
