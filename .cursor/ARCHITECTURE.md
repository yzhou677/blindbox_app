...
**Related:** [`docs/CATALOG_ARCHITECTURE.md`](../docs/CATALOG_ARCHITECTURE.md) (catalog spec — data flow, runtime state, providers, Search V2), [`docs/SEARCH_ARCHITECTURE.md`](../docs/SEARCH_ARCHITECTURE.md) (search-only depth), [`.cursor/rules/`](rules/) (agent rule snippets — **`product-principles`**, **`offline-async-media`**, **`project-architecture`**), [`FIRESTORE_CATALOG_SCHEMA.md`](../lib/features/catalog/firestore/FIRESTORE_CATALOG_SCHEMA.md), [`FIREBASE_STORAGE_CATALOG.md`](../lib/features/catalog/firestore/FIREBASE_STORAGE_CATALOG.md)
...
- **UI readiness:** [`catalogAvailabilityProvider`](../lib/features/catalog/application/catalog_availability.dart) — loading / offlineFirstLaunch / ready; widgets must not call Firestore directly.
...
- **Personal collectible memory (Phase 7):** [`CollectionMemoryStore`](../lib/features/collection/data/collection_memory_store.dart) (`collection_memory_v3`), [`buildCollectionMemoryMoments`](../lib/features/collection/application/collection_memory_index.dart), [`interpretCollectionEvolution`](../lib/features/collection/application/collection_evolution_interpreter.dart), editorial [`CollectionMemoryEditorial`](../lib/features/collection/presentation/collection_memory_editorial.dart). One summary whisper + optional series reflection — no timelines or gamification. Collector Type reveal history (`CollectorTypeRevealRecord`, `resolverVersion` **6.1**) is separate dormant Personality Memory — eligibility contract in [`docs/COLLECTION_ARCHITECTURE_NOTES.md`](../docs/COLLECTION_ARCHITECTURE_NOTES.md) § Collector Types (resolver 6.1). Phase 7 whispers: [`docs/COLLECTION_PERSONAL_MEMORY.md`](../docs/COLLECTION_PERSONAL_MEMORY.md).
...
- **For You recommendations:** [`lib/features/recommendations/`](../lib/features/recommendations/) — catalog series only; **tracked** shelf series excluded; Add Series unlocks readiness. **ADR (read before changes):** [`docs/decisions/architecture/ADR-001-recommendation-semantics.md`](../docs/decisions/architecture/ADR-001-recommendation-semantics.md).
...
Historical conformity notes are archived at [`docs/archive/2026-07/CONFORMITY_AUDIT.md`](../docs/archive/2026-07/CONFORMITY_AUDIT.md). Use this file and [`docs/decisions/`](../docs/decisions/) as the current source of truth.
