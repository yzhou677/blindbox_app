...
export type TaxonomyIp = {
  ...
  titleNoiseRisk?: 'low' | 'medium' | 'high';
  /** When true, title tier matches [titleMatchAliases] only (skips short displayName). */
  titleMatchAliasesOnly?: boolean;
...
export const MARKET_TAXONOMY_IPS: TaxonomyIp[] = [
  ...
  },
  {
    ...
    ebayCategoryId: CANONICAL_EBAY_BROWSE_CATEGORY_ID,
    aspectVerified: false,
    ebayPreferredQuery: 'Baby Molly',
    titleMatchAliases: ['BABY MOLLY', 'POCKET FRIENDS', 'MY HUGGABLE DISCOVERY'],
    observedSellerNaming: ['POP MART', 'Baby Molly', 'Pocket Friends', 'My Huggable Discovery'],
  ...
  },
  {
    ...
    brandId: 'pop_mart',
    aliases: ['MEGA SPACE MOLLY', 'SPACE MOLLY'],
    ebayCategoryId: CANONICAL_EBAY_BROWSE_CATEGORY_ID,
    ebayCharacterValue: 'Space Molly',
    aspectVerified: true,
    ebayPreferredQuery: 'Space Molly',
    titleMatchAliases: ['MEGA SPACE MOLLY', 'MEGA SPACE'],
    observedSellerNaming: ['POP MART', 'Mega Space Molly', 'MEGA 100', 'Kennyswork'],
    retrievalMode: 'q_and_verified_character',
    titleNoiseRisk: 'medium',
  },
  {
    ...
    ebayCategoryId: CANONICAL_EBAY_BROWSE_CATEGORY_ID,
    aspectVerified: false,
    ebayPreferredQuery: 'Twinkle Twinkle',
    titleMatchAliases: ['TWINKLE TWINKLE', 'MOON GELATO', 'SWEET DREAMS FORECAST'],
    observedSellerNaming: ['POP MART', 'Twinkle Twinkle', 'MOON GELATO', 'We are Twinkle Twinkle'],
    retrievalMode: 'q_only',
    titleNoiseRisk: 'low',
  },
  {
    ...
    brandId: 'pop_mart',
    aliases: ['BIKINI BOTTOM BUDDIES'],
    ebayCategoryId: CANONICAL_EBAY_BROWSE_CATEGORY_ID,
    aspectVerified: false,
    ebayPreferredQuery: 'Bikini Bottom Buddies',
    titleMatchAliases: [
    ...
    observedSellerNaming: ['POP MART', 'SpongeBob', 'Bikini Bottom Buddies', 'Whimsical Plush'],
    retrievalMode: 'q_only',
    titleNoiseRisk: 'medium',
  },
  {
    ...
    ebayCategoryId: CANONICAL_EBAY_BROWSE_CATEGORY_ID,
    aspectVerified: false,
    ebayPreferredQuery: 'aespa',
    titleMatchAliases: ['AESPA', 'FLUFFY CLUB', 'AESPA FLUFFY'],
    observedSellerNaming: ['POP MART', 'aespa', 'Fluffy Club', 'vinyl plush doll pendant'],
    retrievalMode: 'q_only',
    titleNoiseRisk: 'low',
  },
  {
    ...
    ebayCategoryId: CANONICAL_EBAY_BROWSE_CATEGORY_ID,
    aspectVerified: false,
    ebayPreferredQuery: 'Polar Monster Village',
    titleMatchAliases: [
      'POLAR MONSTER VILLAGE',
      'POLAR IN MONSTER VILLAGE',
      'POLAR SEASON',
    ],
    titleMatchAliasesOnly: true,
